        ...
        link.addEventListener('click', (e) => {
            ...
            sections.forEach(section => {
                ...
                if (section.id === targetId) {
                    ...
                    // 如果切换到地图区域，刷新地图
                    if (targetId === 'dashboard') map.resize();
                }
            });
        });
    });
    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            const defaultPrizes = [
                ...
                { id: 2, name: '二等奖: 雪王自选', img_url: 'https://i.postimg.cc/bYHTybfy/prize3.png', probability: 10 },
                { id: 3, name: '三等奖: 5元红包', img_url: 'https://i.postimg.cc/3wsBRFwR/prize2.png', probability: 15 },
                { id: 4, name: '四等奖: 柠檬水一杯', img_url: 'https://i.postimg.cc/TwHTg1Zp/prize4.png', probability: 20 },
                { id: 5, name: '五等奖: 谢谢惠顾', img_url: 'https://i.postimg.cc/QM9mhyhw/hanks.png', probability: 50 }
            ];
